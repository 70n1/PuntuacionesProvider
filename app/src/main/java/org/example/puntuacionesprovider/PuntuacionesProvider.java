...
public class PuntuacionesProvider extends ContentProvider {
    ...
    public String getType(final Uri uri) {
        switch (URI_MATCHER.match(uri)) {
            case TODOS_LOS_ELEMENTOS:
                return "vnd.android.cursor.dir/vnd.com.example.puntuacion";
            case UN_ELEMENTO:
                return "vnd.android.cursor.item/vnd.com.example.puntuacion";
            default:
    ...
    @Override
    public Cursor query(Uri uri, String[] proyeccion, String seleccion, String[] argSeleccion, String orden) {
    ...
    @Override
    public int update(Uri uri, ContentValues valores, String seleccion, String[] ArgumentosSeleccion) {
        switch (URI_MATCHER.match(uri)) {
            case TODOS_LOS_ELEMENTOS:
                break;
            case UN_ELEMENTO:
